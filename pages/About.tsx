      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-20 px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="mb-16 animate-fade-in [animation-delay:0.3s]">
            <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-[8rem] font-serif font-bold text-[#1a1a1a] leading-[0.9] tracking-tight mb-2">
              ADVOCACY
            </h2>
            <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-[8rem] font-serif font-bold text-[#1a1a1a] leading-[0.9] tracking-tight mb-2">
              THROUGH
            </h2>
            <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-[8rem] font-serif font-bold text-[#8b5e3c] leading-[0.9] tracking-tight">
              INTEGRITY
            </h2>
          </div>
