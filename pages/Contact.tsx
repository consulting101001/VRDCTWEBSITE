    ...
    <div className="bg-gradient-to-br from-[#f4f7f9] to-[#e9edf2] min-h-screen animate-in fade-in duration-700">
      ...
      <section className="relative py-24 md:py-48 overflow-hidden border-b border-blue-900/5">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 text-center">
          ...
          <h2 className="text-2xl md:text-7xl font-serif font-bold text-[#1a2b3c] tracking-tight uppercase leading-tight">UNITED ARAB EMIRATES</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className="bg-white p-8 md:p-16 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.1)] border border-blue-900/5 rounded-sm relative mt-8 lg:mt-0">
            ...
            <div className="mb-10">
              <Link
                to="/consultation"
                className="group flex items-center justify-between w-full px-8 py-5 bg-dark-primary text-gold border border-gold/20 hover:bg-gold hover:text-black transition-all duration-500 shadow-2xl"
              >
                <div className="flex items-center space-x-4">
                  <Calendar className="w-5 h-5" />
                  <span className="text-[11px] font-black uppercase tracking-[0.4em]">Schedule Consultation</span>
                </div>
